...
export default function RequestFields({ title, objectName, setObjectName, materials, setMaterials, emptyMaterial, sendFormButTitle="Отправить", disableAddFileBut}) {
